...
const MoodEntry = () => {
  ...
  const handleSaveMood = async () => {
    ...
    try {
      ...
      // Convert mood to a numeric value (1-10 scale)
      ...
      const value = moodValues[currentMood] || 5;
      ...
      toast.error('An error occurred while saving your mood');
    } finally {
                ...
                <Card className="w-full max-w-md bg-black/40 backdrop-blur-lg rounded-2xl shadow-xl border border-white/10 overflow-visible">
                  <CardContent className="p-6">
                    ...
                    <motion.div 
                      ...
                      className="mt-10"
                    >
                      <p className="text-white/60 text-xs text-center mb-4">Your mood will be recorded privately</p>
