...
const RecentMoodJars = () => {
  ...
  const fetchMoodJars = async () => {
    ...
    try {
      ...
      // Fetch mood jar records from the database
      ...
      if (data && data.length > 0) {
        // For each mood jar, check if the URL is valid
        // If not, it could be a file path instead of a signed URL that's expired
