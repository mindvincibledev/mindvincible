    ...
    <div className="waves-container fixed inset-0 z-0 overflow-hidden pointer-events-none">
      ...
      >
        ...
        <g className="wave-parallax">
          ...
          <use xlinkHref="#wave" x="48" y="5" fill="rgba(61, 253, 255, 0.10)" className="animate-wave3"/>
          <use xlinkHref="#wave" x="48" y="7" fill="rgba(245, 223, 77, 0.08)" className="animate-wave4"/>
          <use xlinkHref="#wave" x="48" y="9" fill="rgba(252, 104, 179, 0.06)" className="animate-wave1" style={{ animationDelay: '0.5s' }}/>
          <use xlinkHref="#wave" x="48" y="11" fill="rgba(42, 194, 14, 0.04)" className="animate-wave2" style={{ animationDelay: '0.75s' }}/>
        </g>
      </svg>
    </div>
  );
