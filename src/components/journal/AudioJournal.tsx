...
const AudioJournal: React.FC<AudioJournalProps> = ({ onAudioChange, onTitleChange, title }) => {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        <Label htmlFor="audio-journal-title" className="text-white mb-2 block">
          Audio Journal Title
        </Label>
        <Input
          ...
          className="bg-black/20 backdrop-blur-sm border-[#FF8A48]/30 text-white placeholder-gray-400"
        />
      </div>
      
      <div className="flex flex-col items-center gap-4 p-6 rounded-lg border border-[#FF8A48]/30 bg-black/20 backdrop-blur-sm">
        ...
        <div className="flex items-center gap-4">
          {!isRecording ? (
            <Button 
              ...
              className="bg-[#FF8A48] hover:bg-[#FF8A48]/80 text-white flex items-center gap-2"
            >
